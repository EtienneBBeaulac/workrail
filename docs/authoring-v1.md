# Workflow Authoring Guide (v1)

This document describes workflow authoring for the **current shipped WorkRail system (v1)**.

> **Important:** WorkRail v2 authoring is different by design. For v2, use `docs/authoring-v2.md` and the canonical reference `docs/design/workflow-authoring-v2.md`.
