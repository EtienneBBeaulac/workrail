# Agent Context Optimization Guide (v1)

This guide documents **v1 behavior** where agents send large `context` payloads to `workflow_next`.

> For WorkRail v2, use `docs/features/agent-context-guidance-v2.md` and the canonical v2 contract: `docs/reference/workflow-execution-contract.md`.
