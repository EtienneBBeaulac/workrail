# Feature Flags Architecture (v1)

This document describes the feature flag architecture for the **current shipped WorkRail system (v1)**.

> For WorkRail v2, see `docs/features/feature-flags-architecture-v2.md` and the canonical v2 locks in `docs/design/v2-core-design-locks.md` (desired vs applied, restart-required, tool discovery bounded).
