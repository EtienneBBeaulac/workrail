    ...
    >
      ...
      >
        ...
        <div className="flex-1 p-4 min-w-0">
          ...
          {/* Branch description -- from `git config branch.<name>.description` */}
          {item.worktree?.description && (
            <p className="text-xs text-[var(--text-muted)] italic leading-snug mb-3 truncate">
              {item.worktree.description}
            </p>
          )}
